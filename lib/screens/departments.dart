...
import 'package:worldquestionbank/screens/subject_List.dart';
import 'package:worldquestionbank/utilitys/colors.dart';
import 'package:worldquestionbank/utilitys/textstyle.dart';

class DepartmentList extends StatelessWidget {
  Question? model;
  DepartmentList({super.key, this.model});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Exam ${model!.Questions.toString()}'),
        ),
