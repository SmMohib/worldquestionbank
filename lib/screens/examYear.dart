...
import 'package:worldquestionbank/screens/departments.dart';
import 'package:worldquestionbank/utilitys/colors.dart';
import 'package:worldquestionbank/utilitys/textstyle.dart';

class ExamYearList extends StatelessWidget {
  Question? model;
  ExamYearList({super.key, this.model});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Exam Years ${model!.Questions.toString()}'),
        ),
